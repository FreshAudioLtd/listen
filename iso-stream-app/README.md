...
- **No per-channel volume — just mute/unmute.** This keeps the listener UI simple and
  ...
  Every channel does get a flat **+10dB gain boost** applied on the broadcaster's side
  ...
  going in can clip with the extra 10dB — watch the broadcaster's meters, and back off the
